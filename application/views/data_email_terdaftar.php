...
<head>
    ...
    <title>Admin - Email Terdaftar</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="tab-content" id="emailTabsContent">
                        <table id="emailterdaftarTable" class="table table-bordered table-responsive">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Program Studi</th>
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($email_terdaftar as $email): ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $email['prodi']; ?></td>
                                        <td><?= $email['nim']; ?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="deleteForm" method="post" action="<?= site_url('AdminPengajuanController/deleteEmailTerdaftar'); ?>">
