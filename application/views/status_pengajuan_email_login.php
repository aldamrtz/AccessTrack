                ...
                <div class="form-wrapper">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin-top: 25px; margin-left: -50px;">
                            ...
                            <form action="<?= base_url('EmailController/status_pengajuan_email_login'); ?>" id="login-form" method="post">
                                <div class="mb-3">
                                    <input type="email" class="form-control" id="email" name="email_pengguna" required placeholder=" ">
        ...
        document.getElementById('login-form').addEventListener('submit', function(e) {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute('6Lf0PEQqAAAAANCvF8-NRJwRcVHMZDMbSD84j7gZ', {
                    ...
                    fetch('<?php echo site_url('EmailController/status_pengajuan_email_login'); ?>', {
                            method: 'POST',
                            body: formData
                        })
                        ...
                        .then(text => {
                            ...
                            try {
                                ...
                                if (data.success) {
                                    window.location.href = '<?php echo site_url('EmailController/status_pengajuan_email'); ?>';
                                } else {
